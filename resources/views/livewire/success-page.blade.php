              ...
              <div class="flex items-start justify-start flex-shrink-0">
                <div class="flex items-center justify-center w-full pb-6 space-x-4 md:justify-start">
                  <div class="flex flex-col items-start justify-start space-y-2">
                    ...
                    <p class="text-sm leading-4 text-gray-600 dark:text-gray-400">{{ $order->address->street_adress }}</p>
                    <p class="text-sm leading-4 text-gray-600 dark:text-gray-400">
                       {{ $order->address->kelurahan }}, {{ $order->address->kecamatan }}, {{ $order->address->city }}, {{ $order->address->kode_pos }}</p>
                    </p>
