      ...
      <div class="md:w-3/4">
              ...
              <tr wire:key="{{ $item->id }}">
                <td class="py-4">
                  <div class="flex items-center">
                    <img class="h-16 w-16 mr-4" src="{{ url('storage', $item->product->images) }}" 
        ...
        <div class="bg-white overflow-x-auto rounded-lg shadow-md p-6 mb-4">
          ...
          <div class="flex justify-between items-center">
            <div>
              <p>{{ $address->street_adress }}, {{ $address->kelurahan }}, {{ $address->kecamatan }}, {{ $address->kode_pos }}</p>
            </div>
            <div>
      ...
      <div class="md:w-1/4">
        <div class="bg-white rounded-lg shadow-md p-6">
          ...
          <div class="flex justify-between mb-2">
            <span>Subtotal</span>
            <span>
              {{ Number::currency($item->order->total_price, 'Rp.') }} 
            </span>
          </div>
          <div class="flex justify-between mb-2">
            <span>Taxes</span>
