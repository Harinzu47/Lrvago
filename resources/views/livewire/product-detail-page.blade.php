                ...
                <div class="w-full mb-8 md:w-1/2 md:mb-0">
                    <div class="sticky top-0 z-20 overflow-hidden">
                        <div class="relative mb-6 lg:mb-10 lg:h-2/4">
                            <img src="{{ url('storage', $product->images) }}" alt="{{ $product->name }}" class="object-cover w-full lg:h-full">
                        </div>
                    ...
                    <div class="lg:pl-20">
                        <div class="mb-8">
                            ...
                            <p class="inline-block mb-6 text-4xl font-bold text-gray-700 dark:text-gray-400 ">
                                ...
                                {{-- <span class="text-base font-normal text-gray-500 line-through dark:text-gray-400">$25.99</span> --}}
                            </p>
                        ...
                        <div class="mt-4">
                            <p class="text-gray-700 dark:text-gray-400">Stock: <span class="font-bold">{{ $product->stock }} Kg</span></p>
                        </div>
                    </div>
                </div>
            </div>
